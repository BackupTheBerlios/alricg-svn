 ...
 *
 */
public class ProfessionView extends RefreshableHerkunftViewPart {
	public static final String ID = "org.d3s.alricg.editor.views.ProfessionView"; //$NON-NLS-1$
	...
	public static class ProfessionAufwandProvider extends ColumnLabelProvider {
		@Override
		public String getText(Object element) {
			CharElement chatEle = ViewUtils.getCharElement(element);
			if (chatEle == null) return ""; //$NON-NLS-1$
			
			return ((Profession) chatEle).getAufwand().getValue();
		}
	}
	
	public static class ProfessionAufwandSorter extends CreatableViewerSorter {
		@Override
		public Comparable getComparable(Object obj) {
			return ((Profession) getCharElement(obj)).getAufwand().getValue();
		}
	}
	
	public static class ProfessionArtProvider extends ColumnLabelProvider {
		@Override
		public String getText(Object element) {
			CharElement chatEle = ViewUtils.getCharElement(element);
			if (chatEle == null) return ""; //$NON-NLS-1$
			
			return ((Profession) chatEle).getArt().toString();
		}
	}
	
	public static class ProfessionArtSorter extends CreatableViewerSorter {
		@Override
		public Comparable getComparable(Object obj) {

 ...
 * @author Vincent
 */
public class RasseView extends RefreshableHerkunftViewPart {
	public static final String ID = "org.d3s.alricg.editor.views.RasseView"; //$NON-NLS-1$
	...
	public static class RasseArtProvider extends ColumnLabelProvider {
		@Override
		public String getText(Object element) {
			CharElement chatEle = ViewUtils.getCharElement(element);
			if (chatEle == null) return ""; //$NON-NLS-1$
			
			return ((Rasse) chatEle).getArt().toString();
		}
	}
	
	public static class RasseArtSorter extends CreatableViewerSorter {
		@Override

...
/**
 * Ansicht mit allen View für die Bearbeitung von der Herkunft.
 * @author Vincent
 */
public class HerkunftPerspective implements IPerspectiveFactory {
	public static final String ID = "org.d3s.alricg.editor.rcp.HerkunftPerspective";
	...
	public void createInitialLayout(IPageLayout layout) {
        ...
        IFolderLayout bottomFolder = layout.createFolder(
        		...
        		editorArea);        bottomFolder.addView(RasseView.ID);
        bottomFolder.addView(KulturView.ID);
        bottomFolder.addView(ProfessionView.ID);
        ...
        bottomFolder.addView(RegionVolkView.ID);

...
public class KulturView extends GeneralRefreshableViewPart {
	...
	public static class KulturBildProvider extends ColumnLabelProvider {
		@Override
		public String getText(Object element) {
			// TODO implement
			return ""; //$NON-NLS-1$
...
// ----------------------------------------------------------------------
	...
	public static class KulturBildSorter extends CreatableViewerSorter {
		@Override
		public Comparable getComparable(Object obj) {
			// TODO implement
			return ""; 
